...
if __name__ == "__main__":
    ...
    argParser.add_argument("-pnode", type=str, help="Hostname for primary node")
    argParser.add_argument("-snode", type=str, help="Hostname for secondary node")
    argParser.add_argument("-pnode_user", type=str, default="root", help="User for primary node")
    argParser.add_argument("-pnode_passwd", type=str, help="Password for primary node")
    argParser.add_argument("-snode_passwd", type=str, help="Password for secondary node")
    argParser.add_argument("-snode_user", type=str, default="root", help="User for secondary node")
    argParser.add_argument("-C", type=str, help="Cluster ip for HW")
    argParser.add_argument("-V", type=str, help="Management vip for HW")
    ...
    argParser.add_argument("-I", type=str,
                           help=("IP address for public n/w interface name on node-2,"
                                 ...
                                 "provided for -N option."))
    argParser.add_argument("-A", type=str, help="IP address of controller A (default 10.0.0.2)")
    argParser.add_argument("-B", type=str, help="IP address of controller B (default 10.0.0.2)")
    argParser.add_argument("-U", type=str, default="manage",
                           help="User for controller (default 'manage')")
    argParser.add_argument("-P", type=str, help="Password for controller (default 'passwd')")
